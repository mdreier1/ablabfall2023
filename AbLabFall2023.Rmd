...
mean(data$PSWQ_Total_post) # Mean pre
sd(data$PSWQ_Total_post) #SD pre


```
## Test of Differences in Anxiety (PSWQ)
...
## Test of Differences in Positive Emotions
...
## Test of Differences in Negative Emotions
